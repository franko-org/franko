...
static const int COINBASE_MATURITY_NEW = COINBASE_MATURITY;
/** Block at which COINBASE_MATURITY_NEW comes into effect **/
static const int COINBASE_MATURITY_SWITCH = 0;
...
inline bool AllowFree(double dPriority)
{
    ...
    // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // Franko: 1440 blocks found a day. Priority cutoff is 100 franko day / 250 bytes.
    }
 ...
 */
// Franko specific implementation, standardizes checks for the hard maturity change at block 145k
