...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MFRK);
    unitlist.append(kFRK);
    unitlist.append(FRK);
    unitlist.append(Topher);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MFRK: return QString("MFRK");
    case kFRK: return QString("kFRK");
    case FRK: return QString("FRK");
    case Topher: return QString("Topher");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MFRK: return QString("Mega-Franko (1,000,000 FRK)");
    case kFRK: return QString("Kilo-Franko (1000 FRK)");
    case FRK: return QString("Franko");
    case Topher: return QString("Topher (1 / 100,000,000");
    default: return QString("???");
    }
}
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MFRK: return Q_INT64_C(100000000000000);
    case kFRK: return Q_INT64_C(100000000000);
    case FRK:  return Q_INT64_C(100000000);
    case Topher: return Q_INT64_C(1);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MFRK: return Q_INT64_C(900000);
    case kFRK: return Q_INT64_C(900000000);
    case FRK:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
    case Topher: return Q_INT64_C(9000000000000000000); // Slightly under max value for int64
    default:   return 0;
    }
}
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MFRK: return 6;  // 900,000 (# digits, without commas)
    case kFRK: return 9;  // 900,000,000
    case FRK:  return 12; // 900,000,000,000
    case Topher: return 19; // 9,000,000,000,000,000,000
    default: return 0;
    }
}
