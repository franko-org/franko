...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s franko-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  franko-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded franko transaction") + "\n" +
              "  franko-tx [options] -create [commands]   " + _("Create hex-encoded franko transaction") + "\n" +
              "\n";
