...
public:
    CMainParams() {
        ...
        std::vector<unsigned char> pka = list_of(35);
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testfrk.lionservers.de", "testfrk-seed.lionservers.de"));
        vSeeds.push_back(CDNSSeedData("lionservers.de", "testfrk-seed-static.lionservers.de"));
