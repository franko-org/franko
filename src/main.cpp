...
#if defined(NDEBUG)
# error "Franko cannot be compiled without assertions."
#endif
...
//TODO: this isn't identical to franko reference client.
...
static const int64_t nTargetTimespan = 4 * 60 * 60; // Franko: every 4 hours
static const int64_t nTargetTimespanNEW = 60 ; // Franko: every 1 minute
static const int64_t nTargetSpacing = 60; // Franko: 1 minute
...
bool ConnectBlock(CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
    ...
    // BIP16 was always active in Franko
...
{
    // Franko: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
